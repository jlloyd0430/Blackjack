...
function deal() {
  ...
  let myInterval = setInterval(() => {
    ...
    if (dealCounter != 2) {
      ...
      // this is the dealers first card
    ...
    if (dealCounter % 2 == 1) {
      ...
      // 27. Increment and output the player's score
      ...
      //if dealer has been dealt both cards
      if (dealCounter == 4) {
    ...
    console.log("dealerHand: ", dealerHand, "playerHand: ", playerHand);
  ...
  //       setTimeout(() => {
  //         outputH2.textContent = "You Both have Blackjack--PUSH!!!";
